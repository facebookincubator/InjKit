...
public class CrashShieldViewsInjectionTest {
    ...
    @Test
    public void fakeViewAOnMeasure_throwsExceptionBeforeSuperCall_catchException()
            throws Exception {

        ClassLoader classLoader = processClasses(FakeViewA.class, FakeViewB.class,
            Class.forName(FakeViewA.class.getName() + "$1"));
        Class<?> cls = classLoader.loadClass(FakeViewB.class.getName());
        SafeView instance =
                (SafeView) cls.getConstructor(
                        Context.class)
                        .newInstance(
    ...
    @Test
    public void fakeViewAOnMeasure_throwsExceptionAfterSuperCall_catchException()
            throws Exception {
    ...
    @Test
    public void fakeViewBOnMeasure_throwsExceptionBeforeSuperCall_catchException()
            throws Exception {
    ...
    @Test
    public void fakeViewBOnMeasure_throwsExceptionAfterSuperCall_catchException()
            throws Exception {
    ...
    @Test
    public void processFakeViewA_withAnonymousClass_shouldRenameInAnonymousClass()
        throws Exception {

        ClassLoader classLoader = processClasses(FakeViewA.class,
            Class.forName(FakeViewA.class.getName() + "$1"));
        Class<?> cls = classLoader.loadClass(FakeViewA.class.getName());
        View fakeViewA =
            (View) cls.getConstructor(
                Context.class)
                .newInstance(
                    RuntimeEnvironment.application);
