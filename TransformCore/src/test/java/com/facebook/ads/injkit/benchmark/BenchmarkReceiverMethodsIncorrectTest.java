...
public class BenchmarkReceiverMethodsIncorrectTest {
    ...
    public static List<Object[]> getParameters() {
        return Arrays.asList(new Object[][] {
                ...
                {
                    NonPublicExecutedWarningMethod.class,
                    new String[] { "executedWithWarning", "public" }
                },
                {
                    NonStaticExecutedWarningMethod.class,
                    new String[] { "executedWithWarning", "static" }
                },
                {
    ...
    public void missingExecutedMethod() throws Exception {
        ...
        try {
            environment.newLoadableConfigurationWriter()
