...
public class CrashShieldConfigurationWriter
    ...
    CrashShieldConfigurationWriter<T> transformAnnotation(
            String transformAnnotationClassName) {
        this.transformAnnotationClassName = transformAnnotationClassName;
        return this;
    }

    public CrashShieldConfigurationWriter<T> transformAnnotation(
            Class<?> transformAnnotation) {
        return transformAnnotation(transformAnnotation.getName());
    }

    CrashShieldConfigurationWriter<T> noTransformAnnotation(
            String noTransformAnnotationClassName) {
        this.noTransformAnnotationClassName = noTransformAnnotationClassName;
        return this;
    }

    public CrashShieldConfigurationWriter<T> noTransformAnnotation(
            Class<?> noTransformAnnotation) {
