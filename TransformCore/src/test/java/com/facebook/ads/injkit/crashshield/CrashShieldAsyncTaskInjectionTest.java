...
import static com.facebook.ads.injkit.crashshield.CrashShieldAsyncTaskInjectionTest.FakeAsyncTask.SUCCESS;
...
public class CrashShieldAsyncTaskInjectionTest {
    ...
    public void execute_afterAsyncTaskProcessing_shouldWorkCorrectly() throws Exception {
        ...
        AsyncTask<Integer, String, String> instance = (AsyncTask<Integer, String, String>)
            cls.getConstructor(AtomicBoolean.class).newInstance(finishedCondition);
        instance.executeOnExecutor(new Executor() {
            @Override
        ...
        assertEquals(SUCCESS, resultField.get(instance));
    }
