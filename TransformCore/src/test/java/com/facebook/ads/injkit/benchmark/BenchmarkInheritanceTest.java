...
public class BenchmarkInheritanceTest {
    ...
    static class BaseClass {
        ...
        public void benchmarkedMethod1(int sleepMs) { BaseClass.doSleep(sleepMs); }
        @BenchmarkAnn
        public void benchmarkedMethod2(int sleepMs) { BaseClass.doSleep(sleepMs); }
        @BenchmarkAnn(warnAtMillis = WARN_BASE_MS)
        public void benchmarkedMethod3(int sleepMs) { BaseClass.doSleep(sleepMs); }
        @BenchmarkAnn
        public void benchmarkedMethod4(int sleepMs) { BaseClass.doSleep(sleepMs); }
        @BenchmarkAnn(warnAtMillis = WARN_BASE_MS)
        public void benchmarkedMethod5(int sleepMs) { BaseClass.doSleep(sleepMs); }
        @BenchmarkAnn
        public void benchmarkedMethod6(int sleepMs) { BaseClass.doSleep(sleepMs); }
    }
