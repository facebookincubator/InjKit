...
class ThreadCheckConfigurationWriter
    ...
    ThreadCheckConfigurationWriter<T> anyThreadAnnotationClass(
    ...
    ThreadCheckConfigurationWriter<T> anyThreadAnnotationClass(
            Class<?> anyThreadAnnotationClass) {
        return anyThreadAnnotationClass(anyThreadAnnotationClass.getName());
    }

    ThreadCheckConfigurationWriter<T> violationHandlerClass(
