...
public class ThreadCheckAnnotationsAreRemovedTest {
  ...
  private static Object annotation(
      ClassLoader ldr, String method, Class<? extends Annotation> annotation) throws Exception {
  ...
  private static Object classAnnotation(
      ClassLoader ldr, Class<?> cls, Class<? extends Annotation> annotation) throws Exception {
