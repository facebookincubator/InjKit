...
public class ThreadCheckIncompatibleDefinitionsTest {
  ...
  @Work
  public static class WorkFromUi implements UiInterface {}

  @Any
  public static class AnyFromUi implements UiInterface {}

  @Work
  interface WorkInterface {}

  @Ui
  public static class UiFromWork implements WorkInterface {}

  @Any
  public static class AnyFromWork implements WorkInterface {}

  @Any
  interface AnyInterface {}

  @Ui
  public static class UiFromAny implements AnyInterface {}

  @Work
  public static class WorkFromAny implements AnyInterface {}
