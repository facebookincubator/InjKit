...
public class KeepsTrackOfMethodAnnotationsTest {
    ...
    public void overriddenMethodAnnotationsFromSuperClassAnnotationsReportedInClosure() {
        assertThat(model.methodClosureWithAnnotationFilter(
    ...
    public void privateMethodsFromSuperClassNotReportedInClosure() {
        assertThat(model.methodClosureWithAnnotationFilter(
                "e/F", "bar", "(I)I", Opcodes.ACC_PUBLIC, "Lmy/Ann9;")).isEmpty();
        assertThat(model.methodClosureWithAnnotationFilter(
                "e/F", "bar", "(I)I", Opcodes.ACC_PUBLIC, "Lmy/Ann10;")).isEmpty();
    }

    @Test
    public void staticMethodsFromSuperClassNotReportedInClosure() {
        assertThat(model.methodClosureWithAnnotationFilter(
                "e/F", "bazz", "(Z)Z", Opcodes.ACC_PUBLIC, "Lmy/Ann13;")).isEmpty();
        assertThat(model.methodClosureWithAnnotationFilter(
                "e/F", "bazz", "(Z)Z", Opcodes.ACC_PUBLIC, "Lmy/Ann14;")).isEmpty();
    }

    @Test
    public void staticMethodsFromInterfaceNotReportedInClosure() {
        assertThat(model.methodClosureWithAnnotationFilter(
                "e/F", "bazz", "(Z)Z", Opcodes.ACC_PUBLIC, "Lmy/Ann15;")).isEmpty();
        assertThat(model.methodClosureWithAnnotationFilter(
                "e/F", "bazz", "(Z)Z", Opcodes.ACC_PUBLIC, "Lmy/Ann16;")).isEmpty();
    }
