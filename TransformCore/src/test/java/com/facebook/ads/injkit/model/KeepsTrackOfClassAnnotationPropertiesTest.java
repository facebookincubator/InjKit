...
public class KeepsTrackOfClassAnnotationPropertiesTest {
    ...
    @Before
    public void before() {
        model.update(AsmCreationUtils.makeClassWithAnnotations(
                "my/Cls1",
                "java/lang/Object",
                Arrays.asList(
    ...
    public void findIntegerProperty() {
        assertThat(model.annotationPropertyOfClass("my/Cls1", "Lmy/IntAnn;", "foo"))
                .isEqualTo(42);
    }

    @Test
    public void obtainingNonExistentProperty() {
        assertThat(model.annotationPropertyOfClass("my/Cls1", "Lmy/StringAnn;", "bar"))
                .isNull();
    }
