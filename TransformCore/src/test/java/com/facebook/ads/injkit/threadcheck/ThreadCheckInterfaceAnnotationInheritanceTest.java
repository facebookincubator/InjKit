...
public class ThreadCheckInterfaceAnnotationInheritanceTest {
  ...
  public void uiMethodCalledInNonUi() {
    ...
    assertThat(DummyThreadCheckViolationHandler.uiViolationsAre(TestClass.class, "uiMethod", "()V"))
        .isTrue();
  }
  ...
  public void workerMethodCalledInUi() {
    ...
    assertThat(
            DummyThreadCheckViolationHandler.workerViolationsAre(
                TestClass.class, "workerMethod", "()V"))
        .isTrue();
  }
