...
class CrashShieldInjector extends BaseInjector {
  ...
  static {
    ...
    ANDROID_CLASS_INAME_AND_SAFE_CLASS_INAME_MAP.put(
        "android/view/View", "com/facebook/ads/internal/shield/SafeView");
    ANDROID_CLASS_INAME_AND_SAFE_CLASS_INAME_MAP.put(
        "android/view/ViewGroup", "com/facebook/ads/internal/shield/SafeViewGroup");
    ANDROID_CLASS_INAME_AND_SAFE_CLASS_INAME_MAP.put(
        "android/widget/RelativeLayout", "com/facebook/ads/internal/shield/SafeRelativeLayout");
    ANDROID_CLASS_INAME_AND_SAFE_CLASS_INAME_MAP.put(
        "android/widget/FrameLayout", "com/facebook/ads/internal/shield/SafeFrameLayout");
    ANDROID_CLASS_INAME_AND_SAFE_CLASS_INAME_MAP.put(
        "android/widget/LinearLayout", "com/facebook/ads/internal/shield/SafeLinearLayout");
  ...
  private static void renameSuperClassIfDirectChild(ClassNode clsNode) {
    String safeSuperClassName = ANDROID_CLASS_INAME_AND_SAFE_CLASS_INAME_MAP.get(clsNode.superName);
  ...
  private static void validateHandler(Class<?> handlerClass)
    ...
    ReflectUtils.checkMethodIsPublicStatic(handlerClass, METHOD_FINISHED_METHOD_NAME, Object.class);
  }
  ...
  public static void setSafeNames(String safeViewIName, String safeViewGroupIname) {
    ANDROID_CLASS_INAME_AND_SAFE_CLASS_INAME_MAP.put("android/view/View", safeViewIName);
    ANDROID_CLASS_INAME_AND_SAFE_CLASS_INAME_MAP.put("android/view/ViewGroup", safeViewGroupIname);
  }
}
