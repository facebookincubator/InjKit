...
public interface Model {
    ...
    default Set<String> hierarchicalMethodClosure(
            ...
            String desc,
            int access) {
        return hierarchicalClosure(iName)
                .stream()
    ...
    default Set<String> methodClosureWithAnnotationFilter(
            ...
            int access,
            String annotationDesc) {
        return hierarchicalMethodClosure(iName, name, methodDesc, access)
                .stream()
                .filter(i ->
                        annotationsOfMethod(i, name, methodDesc, access).contains(annotationDesc))
                .collect(Collectors.toSet());
    }
    ...
    default Map<String, Object> closureWithAnnotationFilterAndValue(
            ...
            String desc,
            String property) {
        return closureWithAnnotationFilter(iName, desc)
                .stream()
    ...
    default Map<String, Object> methodClosureWithAnnotationFilterAndValue(
        ...
        return methodClosureWithAnnotationFilter(iName, name, methodDesc, access, annotationDesc)
                .stream()
                .map(i -> new Object[] { i, annotationPropertyOfMethod(
                        i,
                        name,
                        methodDesc,
                        access,
